...
def parse_args():
    ...
    parser.add_argument("--variavel", type=int, default=0, help="Define o alvo do ataque") # Quantidade de atacantes, início do ataque, ruído aplicado (Seu referencial de ruído será dividido por 100)
