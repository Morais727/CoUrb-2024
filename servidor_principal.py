...
class Timming(fl.server.strategy.FedAvg):
    ...
    def __init__(
        ...
        *,
        ...
        modelo_mnist_dnn_path = 'MODELOS/CLASSIFICADOR_XGB_cifar_cnn.h5'

        minmax_cifar10_cnn_path = 'MODELOS/MINMAX_XGB_mnist_dnn.pkl'
        modelo_cifar10_cnn_path = 'MODELOS/CLASSIFICADOR_XGB_mnist_dnn.h5'
